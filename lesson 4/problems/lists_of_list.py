...
usa_univs = [ ['California Institute of Technology',2175,37704],
              ...
              ['Yale',11701,40500]  ]
# giving the total number of students enrolled at all of the universities in the list, and the total tuition fees
# (which is the sum of the number of students enrolled times the tuition fees for each university).
def total_enrollment(unis):
# three elements: a university name,the total number of students enrolled, and the annual tuition fees. 
    total_students=0
    total_fees=0
    for x in unis:
        total_students+=x[1]
